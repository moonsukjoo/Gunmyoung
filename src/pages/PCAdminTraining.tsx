      ...
      <div className="max-w-[1600px] mx-auto space-y-10 text-foreground">
        <div className="flex justify-between items-end">
          <div className="space-y-4">
            <h2 className="text-3xl font-black text-foreground tracking-tight">교육 및 평가 관리</h2>
            <p className="text-muted-foreground font-medium">건명기업 임직원들의 안전 교육 이수 현황과 직무 자격을 체계적으로 관리합니다.</p>
          </div>
          <div className="flex gap-3">
            <button className="px-6 py-4 bg-primary text-primary-foreground rounded-2xl font-black text-sm flex items-center gap-3 hover:bg-primary/90 transition-all shadow-lg shadow-primary/10">
        ...
        <div className="bg-card p-6 rounded-[2rem] border border-border shadow-sm flex flex-wrap gap-4 items-center">
          ...
          <button className="px-8 py-4 bg-card border border-border rounded-2xl text-sm font-black flex items-center gap-2 hover:bg-muted transition-all text-foreground">
                ...
                <tr key={record.id} className="group hover:bg-primary/5 transition-all">
                  ...
                  <td className="px-8 py-6">
                    <div className="flex justify-center">
                      <button className="flex items-center gap-2 px-4 py-2 bg-card border border-border rounded-lg text-[10px] font-black text-muted-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all shadow-sm">
